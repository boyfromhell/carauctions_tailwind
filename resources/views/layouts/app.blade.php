            ...
            <div class="container mx-auto h-full">
                <div class="flex items-center justify-center h-12">
                    ...
                    <div class="flex-1 text-right">
                        @guest
                            <a class="no-underline text-teal-darker pr-3 text-sm" href="{{ url('/login') }}">{{ __('Login') }}</a>
                            <a class="no-underline text-teal-darker text-sm" href="{{ url('/register') }}">{{ __('Register') }}</a>
                        @else
